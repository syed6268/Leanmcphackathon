 ...
 */
export function setupMinimalResource(server) {
    // Portfolio Overview Resource
    server.registerResource("portfolio-overview", "robinhood://portfolio/overview", {
    ...
    server.registerResource("market-overview", "robinhood://market/overview", {
    ...
    server.registerResource("risk-analysis", "robinhood://portfolio/risk", {
